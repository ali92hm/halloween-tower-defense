...
public class DenseLightningTower extends Tower 
{
	...
	public int path1CurrentValue() {
		return (getChainLightningUpgrade() ? ChainingDenseLightning.getDamageLevelBoost(this.path1UpgradeLevel) :
	...
	public int path1UpgradeValue() {
		return this.path1UpgradeLevel == 3 ? -1 :
			(getChainLightningUpgrade() ? ChainingDenseLightning.getDamageLevelBoost(this.path1UpgradeLevel+1) :
