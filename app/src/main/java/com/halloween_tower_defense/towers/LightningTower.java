...
public class LightningTower extends Tower {
	...
	public int path1CurrentValue() {
		return (getChainLightningUpgrade() ? ChainLightning.getDamageLevelBoost(this.path1UpgradeLevel) :
	...
	public int path1UpgradeValue() {
		return this.path1UpgradeLevel == 3 ? -1 :
			(getChainLightningUpgrade() ? ChainLightning.getDamageLevelBoost(this.path1UpgradeLevel+1) :
