...
public class TalentTreeView extends JPanel implements ActionListener {
  ...
  private final JPanel tier3 = new JPanel(gbLayout);
  private final JPanel tier4 = new JPanel(gbLayout);
  private final JPanel tier5 = new JPanel(gbLayout);
  private final JPanel tier6 = new JPanel(gbLayout);
  private final JPanel tier7 = new JPanel(gbLayout);
  private final JPanel acceptPanel = new JPanel();

  private final JToggleButton increaseDamage = new JToggleButton("", false);
  private final JToggleButton increaseFireRate = new JToggleButton("", false);
  private final JToggleButton increaseRange = new JToggleButton("", false);

  private final JToggleButton increaseGoldLevel = new JToggleButton("", false);
  private final JToggleButton increaseGoldEnemy = new JToggleButton("", false);
  private final JToggleButton reduceGoldTower = new JToggleButton("", false);

  private final JToggleButton chainLightning = new JToggleButton("", false);
  private final JToggleButton damageOverTime = new JToggleButton("", false);
  private final JToggleButton frostDamage = new JToggleButton("", false);

  private final JToggleButton piercingShotTower = new JToggleButton();
  private final JToggleButton patchOfFireTower = new JToggleButton("", false);
  private final JToggleButton stoppingTower = new JToggleButton("", false);

  private final JToggleButton multiShotTower = new JToggleButton("", false);
  private final JToggleButton rangedExplosionTower = new JToggleButton("", false);
  private final JToggleButton icicleTower = new JToggleButton("", false);

  private final JToggleButton lightningMine = new JToggleButton("", false);
  private final JToggleButton fireMine = new JToggleButton("", false);
  private final JToggleButton frostMine = new JToggleButton("", false);

  private final JToggleButton elementalTower = new JToggleButton("", false);
  private final JToggleButton boostTower = new JToggleButton("", false);
  private final JToggleButton moneyTower = new JToggleButton("", false);
  ...
  public void addIcons() {
    increaseDamage.setIcon(
        new ImageIcon(GameView.getImage("IncreaseDamage.png", BUTTON_WIDTH, BUTTON_WIDTH)));
    increaseFireRate.setIcon(
        new ImageIcon(GameView.getImage("FireRate.png", BUTTON_WIDTH, BUTTON_WIDTH)));
    increaseRange.setIcon(
        new ImageIcon(GameView.getImage("Range.png", BUTTON_WIDTH, BUTTON_WIDTH)));
    increaseGoldLevel.setIcon(
        new ImageIcon(GameView.getImage("EndLevelGold.png", BUTTON_WIDTH, BUTTON_WIDTH)));
    increaseGoldEnemy.setIcon(
        new ImageIcon(GameView.getImage("MobGold.png", BUTTON_WIDTH, BUTTON_WIDTH)));
    reduceGoldTower.setIcon(
        new ImageIcon(GameView.getImage("TowerGold.png", BUTTON_WIDTH, BUTTON_WIDTH)));
    chainLightning.setIcon(
        new ImageIcon(GameView.getImage("ChainLightning.png", BUTTON_WIDTH, BUTTON_WIDTH)));
    damageOverTime.setIcon(
        new ImageIcon(GameView.getImage("FieryClock.png", BUTTON_WIDTH, BUTTON_WIDTH)));
    frostDamage.setIcon(
        new ImageIcon(GameView.getImage("IceDamage.png", BUTTON_WIDTH, BUTTON_WIDTH)));
    piercingShotTower.setIcon(
        new ImageIcon(GameView.getImage("DenseLightningTower.png", BUTTON_WIDTH, BUTTON_WIDTH)));
    patchOfFireTower.setIcon(
        new ImageIcon(GameView.getImage("PatchOfFireTower.png", BUTTON_WIDTH, BUTTON_WIDTH)));
    stoppingTower.setIcon(
        new ImageIcon(GameView.getImage("FreezeTower.png", BUTTON_WIDTH, BUTTON_WIDTH)));
    multiShotTower.setIcon(
        new ImageIcon(GameView.getImage("TeslaTower.png", BUTTON_WIDTH, BUTTON_WIDTH)));
    rangedExplosionTower.setIcon(
        new ImageIcon(GameView.getImage("FireBombTower.png", BUTTON_WIDTH, BUTTON_WIDTH)));
    icicleTower.setIcon(
        new ImageIcon(GameView.getImage("IcicleTower.png", BUTTON_WIDTH, BUTTON_WIDTH)));

    ImageIcon comingSoon =
        new ImageIcon(GameView.getImage("ComingSoon.png", BUTTON_WIDTH, BUTTON_WIDTH));
  ...
  public void layoutPanel(JPanel panel, JToggleButton but1, JToggleButton but2,
                          JToggleButton but3) {
  ...
  public void setToolTips() {
    ...
    increaseDamage.setToolTipText("<html>" + "Increase Tower Damage" + "<br>" + "<br>" +
        "Increase the damage your towers do." + "<html>");
    increaseFireRate.setToolTipText("<html>" + "Increase Tower Fire Rate" + "<br>" + "<br>" +
        "Increase the rate at which your towers fire." + "<html>");
    increaseRange.setToolTipText(
        "<html>" + "Increase Tower Range" + "<br>" + "<br>" + "Increase the range of your towers." +
            "<html>");
    increaseGoldLevel.setToolTipText("<html>" + "Increase Gold per Level" + "<br>" + "<br>" +
        "Increase the gold you gain at the end of every level." + "<html>");
    increaseGoldEnemy.setToolTipText("<html>" + "Increase Gold per Enemy" + "<br>" + "<br>" +
        "Increase the gold you gain from killing an enemy." + "<html>");
    reduceGoldTower.setToolTipText("<html>" + "Reduce Gold per Tower" + "<br>" + "<br>" +
        "Decrease the cost of towers by X gold." + "<html>");
    chainLightning.setToolTipText("<html>" + "Chain Lightning" + "<br>" + "<br>" +
        "Gives your lightning tower the ability to chain lightning" + "<html>");
    damageOverTime.setToolTipText("<html>" + "Damage Over Time" + "<br>" + "<br>" +
        "Damage from your fire towers now deals additional damage over time." + "<html>");
    frostDamage.setToolTipText(
        "<html>" + "Frost Damage" + "<br>" + "<br>" + "Your frost towers now deal damage." +
            "<html>");
    piercingShotTower.setToolTipText("<html>" + "Piercing Shot Tower" + "<br>" + "<br>" +
        "Unlock a lightning tower thats projectiles pierce enemies." + "<html>");
    patchOfFireTower.setToolTipText("<html>" + "Patch of Fire Tower" + "<br>" + "<br>" +
        "Unlock a fire tower that leaves a patch of fire after it shoots." + "<html>");
    stoppingTower.setToolTipText("<html>" + "Stopping Tower" + "<br>" + "<br>" +
        "Unlock a frost tower that stops enemies in their tracks." + "<html>");
    multiShotTower.setToolTipText("<html>" + "Multi Shot Tower" + "<br>" + "<br>" +
        "Unlock a lightning tower that shoots multiple shots." + "<html>");
    rangedExplosionTower.setToolTipText("<html>" + "Ranged Explosion Tower" + "<br>" + "<br>" +
        "Unlock a fire tower that shoots a ranged explosion. " + "<html>");
    icicleTower.setToolTipText("<html>" + "Icicle Tower" + "<br>" + "<br>" +
        "Unlock a frost tower that leaves icicles on the ground after it attacks." + "<html>");
    lightningMine.setToolTipText("<html>" + "Lightning Mine" + "<br>" + "<br>" +
        "Unlock a mine that deals single target lightning damage." + "<html>");
    fireMine.setToolTipText("<html>" + "Fire Mine" + "<br>" + "<br>" +
        "Unlock a mine that deals multiple target fire damage." + "<html>");
    frostMine.setToolTipText(
        "<html>" + "Frost Mine" + "<br>" + "<br>" + "Unlock a mine that freezes enemies in place." +
            "<html>");
    elementalTower.setToolTipText("<html>" + "Elemental Tower" + "<br>" + "<br>" +
        "Unlock an elemental tower that deals mixed elemental damage." + "<html>");
    boostTower.setToolTipText("<html>" + "Boost Tower" + "<br>" + "<br>" +
        "Unlock a tower that boots the damage of towers surrounding it." + "<html>");
    moneyTower.setToolTipText("<html>" + "Money Tower" + "<br>" + "<br>" +
        "Unlock a tower that gives you addiontal money whenever enemies die near it." + "<html>");
    accept.setToolTipText("<html>" +
        "Accepting the changes to the talent tree finalizes your talent choices for each tier." +
        "<html>");
  }
  ...
  public int tier1Selected() {
    ...
    if (increaseDamage.isSelected()) {
      return 0;
    } else if (increaseFireRate.isSelected()) {
      return 1;
    } else if (increaseRange.isSelected()) {
      return 2;
    } else {
      return -1;
    }
  ...
  public int tier2Selected() {
    ...
    if (increaseGoldLevel.isSelected()) {
      return 0;
    } else if (increaseGoldEnemy.isSelected()) {
      return 1;
    } else if (reduceGoldTower.isSelected()) {
      return 2;
    } else {
      return -1;
    }
  ...
  public int tier3Selected() {
    ...
    if (chainLightning.isSelected()) {
      return 0;
    } else if (damageOverTime.isSelected()) {
      return 1;
    } else if (frostDamage.isSelected()) {
      return 2;
    } else {
      return -1;
    }
  ...
  public int tier4Selected() {
    ...
    if (piercingShotTower.isSelected()) {
      return 0;
    } else if (patchOfFireTower.isSelected()) {
      return 1;
    } else if (stoppingTower.isSelected()) {
      return 2;
    } else {
      return -1;
    }
  ...
  public int tier5Selected() {
    ...
    if (multiShotTower.isSelected()) {
      return 0;
    } else if (rangedExplosionTower.isSelected()) {
      return 1;
    } else if (icicleTower.isSelected()) {
      return 2;
    } else {
      return -1;
    }
  ...
  public int tier6Selected() {
    ...
    if (lightningMine.isSelected()) {
      return 0;
    } else if (fireMine.isSelected()) {
      return 1;
    } else if (frostMine.isSelected()) {
      return 2;
    } else {
      return -1;
    }
  ...
  public int tier7Selected() {
    ...
    if (elementalTower.isSelected()) {
      return 0;
    } else if (boostTower.isSelected()) {
      return 1;
    } else if (moneyTower.isSelected()) {
      return 2;
    } else {
      return -1;
    }
  ...
  public void paintComponent(Graphics g) {
    ...
    g2.drawImage(GameView.getImage("TalentTreeBackground.png", 700, 650), 0, 0, null);
  }
