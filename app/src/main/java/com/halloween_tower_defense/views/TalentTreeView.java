...
public class TalentTreeView extends JPanel implements ActionListener {
	...
	public void setToolTips(){
		...
		increaseDamage.setToolTipText("<html>" + "Increase Tower Damage" + "<br>" + "<br>" + "Increase the damage your towers do." + "<html>");
		increaseFireRate.setToolTipText("<html>" + "Increase Tower Fire Rate" + "<br>" + "<br>" + "Increase the rate at which your towers fire." + "<html>");
		increaseRange.setToolTipText("<html>" + "Increase Tower Range" + "<br>" + "<br>" + "Increase the range of your towers." + "<html>");
		...
		reduceGoldTower.setToolTipText("<html>" + "Reduce Gold per Tower" + "<br>" + "<br>" + "Decrease the cost of towers by X gold." + "<html>");
		chainLightning.setToolTipText("<html>" + "Chain Lightning" + "<br>" + "<br>" + "Gives your lightning tower the ability to chain lightning" + "<html>");
		damageOverTime.setToolTipText("<html>"+ "Damage Over Time" + "<br>" + "<br>" + "Damage from your fire towers now deals additional damage over time." + "<html>");
		frostDamage.setToolTipText("<html>" + "Frost Damage" + "<br>" + "<br>" + "Your frost towers now deal damage." + "<html>");
		piercingShotTower.setToolTipText("<html>" + "Piercing Shot Tower" + "<br>" + "<br>" + "Unlock a lightning tower thats projectiles pierce enemies." + "<html>");
		...
		boostTower.setToolTipText("<html>" + "Boost Tower" + "<br>" + "<br>" + "Unlock a tower that boots the damage of towers surrounding it." + "<html>");
