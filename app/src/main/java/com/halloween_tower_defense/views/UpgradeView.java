...
public class UpgradeView extends JPanel implements ActionListener {
  ...
  public void cancelConfirmPanel() {
    ...
    if (this.model.getCancelConfirmOption() == 1) {
      ...
      JLabel valueLabel = new JLabel(
          selectedTower.getPath1UpgradeCosts()[selectedTower.getPath1UpgradeLevel()] + "");
      ...
      JLabel upgradeLabel = new JLabel("Upgrade cost: ");
      JLabel valueLabel = new JLabel(
          selectedTower.getPath2UpgradeCosts()[selectedTower.getPath2UpgradeLevel()] + "");
      ...
      JLabel upgradeLabel = new JLabel("Upgrade cost: ");
      JLabel valueLabel = new JLabel(
          selectedTower.getPath3UpgradeCosts()[selectedTower.getPath3UpgradeLevel()] + "");
    ...
    if (this.selectedTower.getPath1UpgradeLevel() != 3 &&
        this.model.getCancelConfirmOption() == 1) {
      this.confirmButton.setEnabled(
          this.selectedTower.getPath1UpgradeCosts()[this.selectedTower.getPath1UpgradeLevel()] <=
              model.getMoney());
    }

    if (this.selectedTower.getPath2UpgradeLevel() != 3 &&
        this.model.getCancelConfirmOption() == 2) {
      this.confirmButton.setEnabled(
          this.selectedTower.getPath2UpgradeCosts()[this.selectedTower.getPath2UpgradeLevel()] <=
              model.getMoney());
    }

    if (this.selectedTower.getPath3UpgradeLevel() != 3 &&
        this.model.getCancelConfirmOption() == 3) {
      this.confirmButton.setEnabled(
          this.selectedTower.getPath3UpgradeCosts()[this.selectedTower.getPath3UpgradeLevel()] <=
              model.getMoney());
    }
  ...
  public void updateInfo() {
    ...
    this.path1Text.setText(
        selectedTower.getPath1UpgradeName() + ": " + selectedTower.path1CurrentValue());
    this.path2Text.setText(
        selectedTower.getPath2UpgradeName() + ": " + selectedTower.path2CurrentValue());
    this.path3Text.setText(
        selectedTower.getPath3UpgradeName() + ": " + selectedTower.path3CurrentValue());

    this.path1Button.setEnabled(this.selectedTower.getPath1UpgradeLevel() != 3);

    this.path2Button.setEnabled(this.selectedTower.getPath2UpgradeLevel() != 3);

    this.path3Button.setEnabled(this.selectedTower.getPath3UpgradeLevel() != 3);
