package com.halloween_tower_defense.controllers;
...
public class DriverController {
  ...
  private final TDMouseWheelListener mouseWheelListener = new TDMouseWheelListener();
  ...
  private class ButtonUpdateListener implements ActionListener {
    public void actionPerformed(ActionEvent e) {
      ...
      if ((view.getMainView().getMap1().isSelected() || view.getMainView().getMap2().isSelected() ||
          view.getMainView().getMap3().isSelected()) &&
          (view.getMainView().getEasyButton().isSelected() ||
              view.getMainView().getMediumButton().isSelected() ||
              view.getMainView().getHardButton().isSelected())) {
  ...
  private class DifficultyListener implements ActionListener {
    public void actionPerformed(ActionEvent e) {
      ...
      } else if (view.getMainView().getMediumButton().isSelected()) {
        model.setDifficulty(2);
      } else if (view.getMainView().getHardButton().isSelected()) {
        model.setDifficulty(3);
      }

      if (view.getMainView().getMap1().isSelected()) {
        model.setMapData(new Map1Data(model, model.getDifficulty()));
      } else if (view.getMainView().getMap2().isSelected()) {
        // model.setMapData(new Map2Data(model.getDifficulty()));
      } else if (view.getMainView().getMap3().isSelected()) {
  ...
  private class TalentTreeActiveAcceptButtonListener implements ActionListener {
    public void actionPerformed(ActionEvent e) {
      view.getSidePanelView().getTalentView().getAccept().setEnabled(model.getTalentPoints() > 0);
    }
  }
  ...
  private class TalentPointListener implements ActionListener {
    public void actionPerformed(ActionEvent e) {
      ...
      if (model.getTalentPoints() == 0) {
        ...
        view.getTalentTreeView()
            .enableButtons(model.getTierDepth(), model.getDisabledButtonArray());
      }
  ...
  private class ButtonMouseMotionListener extends MouseMotionAdapter {
    public void mouseDragged(MouseEvent e) {
      if (((AbstractButton) e.getSource()).isEnabled() &&
          !view.getMapView().getCursor().getName().equals("towerDragged")) {
    ...
    public void actionPerformed(ActionEvent e) {
      if (model.getTalentPoints() > 0 && !model.getRuntimeThread().isAlive()) {
        ...
        if (!model.getRuntimeThread().isAlive()) {
          ...
          model.setStartButtonState(
              view.getSidePanelView().getButtonView().getStartButton().getButtonState());
