...
import main.projectiles.ChainingShock;
import main.projectiles.Projectile;
import main.projectiles.Shock;
import main.projectiles.ThunderBolt;
import main.utilities.Position;
import main.utilities.Vector;
import main.views.Alert;
import main.views.DriverView;
import main.mobs.Mob;
import main.models.DriverModel;

/**
 * Creates a tower that shoots multiple main.controllers.projectiles
...
public class TeslaTower extends Tower 
{
	...
	public Projectile shootMob(final Mob currentAttackingMob, final DriverModel model) {
		...
		switch (currentAttackingMob.getDirection()) {
			...
			break;
			case 'r': xComp = currentAttackingMob.getSpeed();
			break;
			case 'd': yComp = currentAttackingMob.getSpeed();
			break;
