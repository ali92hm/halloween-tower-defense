...
public class Shock extends Projectile {
	...
	public final static int PROJECTILE_MOVEMENTS = 4;
	...
	public Shock(final DriverModel model, final Position startingPosition, final Vector vector,
	...
	public Shock(final DriverModel model, final Position startingPosition, final Vector vector, final Mob chainingMob,
			final int rangeBoostLevel, final int damageBoostLevel) {
		super(model, startingPosition, PROJECTILE_IMAGE, vector, PROJECTILE_WIDTH, PROJECTILE_HEIGHT);
		this.speed = PROJECTILE_SPEED;
		this.radius = PROJECTILE_RADIUS;
